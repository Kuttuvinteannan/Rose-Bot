...
class Development(Config):
    OWNER_ID =  791870939# my telegram ID
    OWNER_USERNAME = "the_kutty"  # my telegram username
    API_KEY = "5104674648:AAGDdIFMMu_7HOldpNSSL6_qUPyetMxtLKM"  # my api key, as provided by the botfather
    SQLALCHEMY_DATABASE_URI = 'postgresql://username:password@localhost:5432/database'  # sample db credentials
    MESSAGE_DUMP = '-1234567890' # some group chat that your bot is a member of
    USE_MESSAGE_DUMP = True
    SUDO_USERS = [791870939,791870939 ]  # List of id's for users which have sudo access to the bot.
    LOAD = []
    NO_LOAD = ['translation']
```
